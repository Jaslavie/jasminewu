...
export default function ProjectSectionRow({
  ...
  return (
    <section className={`py-6 px-6 lg:px-[8vw] ${className}`}>
      <div className="mx-auto">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
          {/* Left Container - Title + Text Content (1/3 width on desktop) */}
          <div className="w-full lg:w-1/3">
            <h2 className="text-white mb-4 lg:mb-6 font-sans font-light tracking-wide">
              {title}
            </h2>
          ...
          <div className="w-full lg:w-2/3">{image}</div>
        </div>
      </div>
    </section>
  );
