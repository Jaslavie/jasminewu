...
export default function HomeContent() {
  return (
    <div className="flex flex-col md:flex-row h-[75vh] px-0 md:px-0 pt-0">
      {/* left content Area */}
      <div
      ...
      >
        {/* Thesis Content */}
        <div
          className="space-y-4 sm:space-y-5 md:space-y-4 lg:space-y-6 max-w-full md:max-w-2xl w-full md:w-[40vw] text-sm sm:text-base md:text-base lg:text-lg xl:text-lg px-6"
          style={{
        ...
        >
          <h2>
            ...
            &{" "}
            <StyledLink href="https://www.gallatin.ai/">Gallatin AI</StyledLink>
