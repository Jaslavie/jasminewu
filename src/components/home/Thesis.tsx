    ...
    <section className="px-[30%] py-20">
      ...
      <div className="space-y-6">
        <p className="thesis-paragraph">
          ...
          isn't smarter AI. It's interfaces where humans and AI think and act as
          one. I'm currently designing decision support systems for battlefield
          ops at{" "}
        ...
        <p className="thesis-paragraph">
          ...
          <Link href="https://devpost.com/jaslavie">hackathon</Link> every
          weekend and won 15, including the world's largest AI hackathon. I
          joined{" "}
          <Link href="https://skydeck.berkeley.edu/">Berkeley Skydeck</Link> to
          build AI agents for 911 dispatchers, hosted the largest{" "}
          <Link href="https://designatuci.com/designathon/24">
            design hackathon
          </Link>{" "}
          in the U.S, and presented my{" "}
        ...
        <p className="thesis-paragraph">
          As a kid I built cardboard claw machines and sold handmade clothes in
          my living room. Augmenting perception and beauty felt like alchemy.
          Henceforth, I made it my life's mission to master (and elevate) the
        ...
        <p className="thesis-paragraph">
          ...
          <Link href="https://en.wikipedia.org/wiki/Mastery_(book)">
            Mastery
          </Link>
          .
        </p>
