    ...
    <div className={pageLayoutClasses.screenSpace}>
        ...
        <div className="flex-1 flex items-center justify-center min-h-0">
            ...
            >
                ...
                {/* Time Display */}
                <p>
                    it's {time} in Los Angeles
                </p>

                {/* Headline with typing cursor */}
                <h3>
                    &gt; Currently: engineering ML systems for battlefield simulations 
                    @ 
                    <Link href="https://www.gallatin.ai/" marginBottom="-10px">Gallatin</Link>
                    <span
                ...
                uncertain environments. My main focus is in adversarial attack
                modeling
                <Citation
                    number={1}
                ...
                />
                . I also study CS & computational neuroscience at UCI.
                </p>

                <p>
                I am an experimentalist at heart and think by building. Recently:
                </p>
                <ul className="list-disc space-y-1 ml-5">
                <li>
                    Designed a system for analyzing military intel at{" "}
                    <Link href="https://time.com/6691662/ai-ukraine-war-palantir/">Palantir</Link>
                </li>
                <li>
